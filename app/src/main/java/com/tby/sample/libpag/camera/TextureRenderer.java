...
public class TextureRenderer {
    ...
    public void draw(int texture, ByteBuffer outBuf, int outWidth, int outHeight) {
        ...
        if (null != outBuf) {
            GLES20.glReadPixels(0, 0, outWidth, outHeight, GLES20.GL_RGBA, GLES20.GL_UNSIGNED_BYTE, outBuf);
        }
